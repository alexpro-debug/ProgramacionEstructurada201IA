...
if __name__ == "__main__":
    ...
    for fila in tablero_ia:
        print(fila)
    tablero_refactorizado = inicializar_tablero_vacio_refactorizado()
    ...
    print("Lista de IDs únicas refactorizada:", depurar_usuarios_repetidos_refactorizado(ids_discord))